...
public:
	...
	void createSampleHeap1() {
		// B0
		NodoBH<T> node1 = new NodoBH();
		initializeNode(node1, 5, 0);
		head = node1;

		// B1
		NodoBH<T> node2 = new NodoBH();
		initializeNode(node2, 17, 1);
		NodoBH<T> node3 = new NodoBH();
		...
		// B3
		NodoBH<T> node4 = new NodoBH();
		initializeNode(node4, 12, 3);
		NodoBH<T> node5 = new NodoBH();
		initializeNode(node5, 18, 2);
		NodoBH<T> node6 = new NodoBH();
		initializeNode(node6, 16, 1);
		NodoBH<T> node7 = new NodoBH();
		initializeNode(node7, 15, 0);
		NodoBH<T> node8 = new NodoBH();
		initializeNode(node8, 23, 1);
		NodoBH<T> node9 = new NodoBH();
		initializeNode(node9, 30, 0);
		NodoBH<T> node10 = new NodoBH();
		initializeNode(node10, 22, 0);
		NodoBH<T> node11 = new NodoBH();
	...
	void createSampleHeap2() {
		// B0
		NodoBH<T> node1 = new NodoBH<T>();
		initializeNode(node1, 5, 0);
		head = node1;

		// B2
		NodoBH<T> node2 = new NodoBH<T>();
		initializeNode(node2, 6, 2);
		NodoBH<T> node3 = new NodoBH<T>();
		initializeNode(node3, 12, 1);
		NodoBH<T> node4 = new NodoBH<T>();
		initializeNode(node4, 34, 0);
		NodoBH<T> node5 = new NodoBH<T>();
		...
		// B3
		NodoBH<T> node6 = new NodoBH<T>();
		initializeNode(node6, 1, 3);
		NodoBH<T> node7 = new NodoBH<T>();
		initializeNode(node7, 2, 2);
		NodoBH<T> node8 = new NodoBH<T>();
		initializeNode(node8, 12, 1);
		NodoBH<T> node9 = new NodoBH<T>();
		initializeNode(node9, 6, 0);
		NodoBH<T> node10 = new NodoBH<T>();
		initializeNode(node10, 4, 1);
		NodoBH<T> node11 = new NodoBH<T>();
		initializeNode(node11, 13, 0);
		NodoBH<T> node12 = new NodoBH<T>();
		initializeNode(node12, 18, 0);
		NodoBH<T> node13 = new NodoBH<T>();
